...
WIRESHARK_ROOT = CONFIG_ROOT / ".chihiros_led_core" / "plugin_data" / "wireshark"
...
def _protocol_helpers() -> tuple[object, object]:
    src = SOURCE_ROOT / "src"
    ...
    return protocol.calculate_checksum, lambda frame: protocol.parse_notification(frame, wrgb_channels)
...
def _decode_wireshark_frame(frame: dict[str, object]) -> dict[str, object]:
    ...
    calculate_checksum, parse_notification = _protocol_helpers()
